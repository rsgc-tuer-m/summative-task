...
void draw() {
  ...
  if (scene == 1) {
    ...
    textAlign(CENTER);
    textSize(16);
    text("2. Deep Love", 650, 300);

    //Answer number 3
    text("3. Greart Friendship", 300, 300);
  } else if (scene == 6) {
    ...
    textAlign(CENTER);
    textSize(16);
    text("2. Animals", 650, 300);

    //Answer number 3 
    text("3. Humans", 300, 300);
  } else if (scene == 7) {
    ...
    textAlign(CENTER);
    textSize(16);
    text("2. A Moose", 650, 300);

    //Answer number 3 AKA CORRECT ANSWER 
    text("3. A Bald Eagle", 300, 300);
  } else if (scene == 9) {
    ...
    textAlign(CENTER);
    textSize(16);
    text("1. Sunnyside Preschool", 470, 300);
    ...
    textAlign(CENTER);
    textSize(16);
    text("2. Sunshine Preschool", 650, 300);

    //Answer number 3 
    text("3. South Side Preschool", 300, 300);
  }
}
void keyPressed() {
  if (scene ==1) {
